...
function Coin(data){
    ...
    this.BlockTemplate = function(template) {
        ...
        this.extraNonce = 0;
        // The ClientNonce needs to be stored on a per requested client location for validation.
        this.clientNonceLocation = this.reserveOffset + 8;
        // ClientChildrenNonces is the 32 bit reserved space for nonces to be assigned to miners.
        // The pool doesn't really care about the values here.  As long as it's valid.
        this.clientChildrenNonceLocation = this.reserveOffset + 12;
        // Define the nonce increment function.
